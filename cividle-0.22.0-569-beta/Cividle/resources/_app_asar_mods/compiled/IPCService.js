...
var IPCService = /** @class */ (function () {
  ...
  IPCService.prototype.fileWriteBytes = function (name, content) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (content.byteLength <= 0) return [2 /*return*/];
            buffer = Buffer.from(content);
            tempFile = "".concat(name, ".tmp");
            tempPath = node_path_1.default.join(
              (0, _1.getGameSavePath)(),
              this.getSteamId(),
              tempFile
            );
  ...
  IPCService.prototype.fileDelete = function (name) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            filePath = node_path_1.default.join(
              (0, _1.getGameSavePath)(),
              this.getSteamId(),
              name
            );
  ...
  IPCService.prototype.getAuthSessionTicket = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this._client.auth.getAuthTicketForWebApi("")];
          case 1:
            return [2 /*return*/, _a.sent().getBytes().toString("hex")];
        }
      });
    });
  };
  ...
  IPCService.prototype.getBetaName = function () {
    var _a;
    return (_a = this._client.apps.currentBetaName()) !== null && _a !== void 0
      ? _a
      : "";
  };
  IPCService.prototype.openMainSaveFolder = function () {
    electron_1.shell.openPath(
      node_path_1.default.join((0, _1.getGameSavePath)(), this.getSteamId())
    );
  };
