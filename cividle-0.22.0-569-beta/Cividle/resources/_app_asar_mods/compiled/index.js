...
exports.MIN_HEIGHT = exports.MIN_WIDTH = exports.getLocalGameSavePath = exports.getGameSavePath = void 0;
...
electron_1.app.commandLine.appendSwitch("log-file", node_path_1.default.join(getLocalGameSavePath(), "CivIdle.log"));
electron_1.app.commandLine.appendSwitch("enable-experimental-web-platform-features");
function getGameSavePath() {
    return node_path_1.default.join(electron_1.app.getPath("appData"), "CivIdleSaves");
}
exports.getGameSavePath = getGameSavePath;
function getLocalGameSavePath() {
    return node_path_1.default.join(electron_1.app.getPath("appData"), "CivIdleLocal");
}
        ...
        switch (_a.label) {
            ...
            case 4:
                if (electron_1.app.isPackaged) {
                    mainWindow_1.loadFile(node_path_1.default.join(__dirname, "..", "dist", "index.html"));
                }
                else {
            ...
            case 5:
                error_2 = _a.sent();
                electron_1.dialog.showErrorBox("Failed to Start Game", String(error_2));
                quit();
                return [3 /*break*/, 6];
